...
offers, bids, payments, logistics, documents). **Invariant:** in both modes, _all binding
commercial state uses the central Singha authoritative backend_ — there are **no** per-country
