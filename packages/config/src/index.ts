...
export function loadConfig(source?: NodeJS.ProcessEnv | Record<string, unknown>): AppConfig {
  ...
  return {
    ...
    features: {
      ...
      flowMatrixV3: env.FEATURE_V3_FLOW_MATRIX,
      categoryOverlayV3: env.FEATURE_V3_CATEGORY_OVERLAY,
      featuredReelV3: env.FEATURE_V3_FEATURED_REEL,
      discoverV3: env.FEATURE_V3_DISCOVER,
      buyerTwinV3: env.FEATURE_V3_BUYER_TWIN,
      bidBattleV3: env.FEATURE_V3_BID_BATTLE,
      gestureBidV3: env.FEATURE_V3_GESTURE_BID,
      ...
      satelliteNodes: env.FEATURE_SATELLITE_NODES,
    },
    providers: {
